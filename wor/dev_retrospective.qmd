...
- **GitHub Flow and Git Flow:** We implemented a Git Flow variant. A development branch was created from `main`, and most feature branches were based off `documentation_dev`. Pull requests were reviewed and merged into `documentation_dev `, then finally into `main` after integration testing. This provided an extra layer for catch issues before release, at the cost of occasional merge conflicts.
